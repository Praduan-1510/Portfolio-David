  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 55% at 50% 42%, color-mix(in srgb, var(--spectrum-violet) 10%, color-mix(in srgb, var(--fg) 4%, transparent)), transparent 70%)",
        }}
      />
      ...
      <Container className="relative z-10 flex flex-1 flex-col items-center justify-center py-space-9 text-center">
        ...
        >
          ...
          <div className="mt-space-7 flex flex-wrap items-center justify-center gap-space-4">
            <Button href="/" variant="invert" size="lg" arrow="left">
              Back home
            </Button>
