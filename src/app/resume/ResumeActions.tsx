      ...
      <Magnetic className="inline-block">
        ...
        >
          ...
          <Printer
            aria-hidden="true"
            strokeWidth={1.75}
            className="h-[15px] w-[15px] shrink-0 transition-transform duration-base ease-out-back group-hover/pr:-translate-y-0.5 group-focus-visible/pr:-translate-y-0.5"
          />
        </Button>
      </Magnetic>
    </div>
