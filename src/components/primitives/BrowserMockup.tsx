        ...
        >
          ...
          {showVideo && hero && (
            <button
              ...
              className="btn-chip absolute bottom-space-2 left-space-2 z-[2] inline-flex items-center gap-[5px] rounded-full px-space-2 py-[2px] font-mono text-[0.6875rem] uppercase tracking-[0.14em] before:absolute before:-inset-3 before:content-['']"
            >
              <span
                aria-hidden="true"
          ...
          {hero && (
            <span className="btn-chip bm-badge pointer-events-none absolute bottom-space-2 right-space-2 z-[2] inline-flex items-center gap-[5px] rounded-full px-space-2 py-[2px] font-mono text-[0.6875rem] uppercase tracking-[0.14em]">
              <span
                className={cn(
