...
<Aside label="Colophon">
  Designed in Figma on one component set: a five-tab shell, one product card, one rating-and-strikethrough price treatment, held across thirteen screens. The filter counts are arithmetic, not placeholder text: "running shoes" returns 48, and the facets underneath add up to it. Decathlon's blue sits one step lighter than the live brand, tuned to clear AA on dark surfaces.
</Aside>
