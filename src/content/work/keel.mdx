...
accent: "#3D6C76" # Passbook teal read as petrol slate: brand #3E6E70 held near its hue but cut to 32% chroma, so it separates from InsightsTap by weight as well as hue. 5.17:1 on paper #F5F0E8, 4.63:1 on --surface.
motif: route
