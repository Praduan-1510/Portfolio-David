...
flows:
  ...
  - title: Daily ledger
    note: "The core loop — see the business at a glance, then record money gave or got."
    screens:
...
I designed Spendee end to end — information architecture, user flows, UI across every screen, and the design system that holds it together.
