...
accent: "#9D4E20" # Voyager orange burnt to a rust ink: brand #F5A623 moved off hue 37 to hue 22 so it cannot collide with the site's own ochre. 5.26:1 on paper #F5F0E8, 4.71:1 on --surface.
motif: route
featured: true
order: 3
flows:
