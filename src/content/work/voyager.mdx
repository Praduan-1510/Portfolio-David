...
<Lede>
Carrying one traveller from *"where should I go?"* all the way to a booked, day-by-day itinerary — collapsing the dozen-tab trip into **one continuous flow**, without losing the wanderlust.
</Lede>

## Overview

Voyager carries someone all the way from *"where should I go?"* to a confirmed, day-by-day itinerary — browsing curated destinations, planning dates and guests, paying, and managing the trip, all in one app. I designed it end to end: information architecture, user flows, UI across every screen, and the design system. It's a concept exploring how the whole arc of travel can live in one place instead of scattered across a dozen tabs.
...
<Stats>
  <Stat value="24" label="screens" />
  <Stat value="5" label="product flows" />
