...
Two hundred and seventy-seven. That's how many sites Expedia's Path to Purchase research says a traveller touches before booking a trip — up seven-fold in a decade. Voyager is a concept that takes that number personally: one app that carries someone from *"where should I go?"* to a confirmed, day-by-day itinerary — browse, plan, pay, travel — without ever leaving. I designed it end to end: information architecture, flows, UI across every screen, and the design system.
...
<Margin label="38 → 277">
  Sites visited per trip, 2013 versus now. The fragmentation isn't nostalgia bait — it's still compounding.
</Margin>
...
<Stats>
  <Stat value="277→1" label="sites per trip (Expedia) versus one flow" />
