...
accent: "#E8A317" # Voyager amber: brand #F5A623 deepened so it separates from the site's own vermilion voice (dE 58) instead of competing with it. 8.62:1 on --bg, 7.74:1 on --surface.
motif: route
featured: true
order: 3
flows:
